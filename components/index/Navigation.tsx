...
const Navigation = ({time}:any) => {
    ...
    const [storageName, setStorageName] = React.useState<string | null>('');
    const [storageEmail, setStorageEmail] = React.useState<string | null>('');
    ...
    return(
        <>
            ...
            <TopContainer ref={elem => (wrapperRef.current[0] = elem)}>
                ...
                <div className="right">
                    ...
                    {jwtToken ? (
                        <div className="right-container" onClick={seeLoginMenuState}>
                            ...
                            <span className='email'>
                                {localStorage.getItem('user-jwt') && localStorage.getItem('user-nickname')}
                                <svg className="arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </span>
                ...
                <span className="title" onClick={()=> console.log(time)}>IP Studio {time}</span>
            </TopContainer>
